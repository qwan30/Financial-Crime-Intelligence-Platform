...
- case creation absence precondition and deterministic ingestion/idempotency key, including duplicate create retry and conflicting create proving canonical null/genesis prior audit values and `409 Conflict` without mutation;
